...
module Models =
    ...
    let createPlayerMove player card =
        { Player = player; PlayedCard = card; } 

    type TurnWinner = TurnWinner of Player option
    ...
    let createTurn playerOneMove playerTwoMove winner =
        { PlayersMoveOne = playerOneMove; PlayersMoveTwo = playerTwoMove; Winner = winner; }
    ...
    let createMatch playerOne playerTwo = 
        { 
            ...
            PlayerTwo = playerTwo;
            RoundHistory = [{ TurnHistory = List.Empty;  Winner = None; }];
            Winner = None;
        }
